...
// Theme.kt
//
// Defines NavThreeScreenTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.navthreescreen.ui.theme
...
/**
 * NavThreeScreenTheme — wrap the app's content in this to apply the design system.
 *
