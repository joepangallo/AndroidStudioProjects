...
// Theme.kt
//
// Defines NavTransitionsTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.navtransitions.ui.theme
...
/**
 * NavTransitionsTheme — wrap the app's content in this to apply the design system.
 *
