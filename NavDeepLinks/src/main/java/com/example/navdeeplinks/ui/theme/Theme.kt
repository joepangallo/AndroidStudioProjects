...
// Theme.kt
//
// Defines NavDeepLinksTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.navdeeplinks.ui.theme
...
/**
 * NavDeepLinksTheme — wrap the app's content in this to apply the design system.
 *
