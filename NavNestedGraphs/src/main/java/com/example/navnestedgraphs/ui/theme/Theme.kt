...
// Theme.kt
//
// Defines NavNestedGraphsTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.navnestedgraphs.ui.theme
...
/**
 * NavNestedGraphsTheme — wrap the app's content in this to apply the design system.
 *
