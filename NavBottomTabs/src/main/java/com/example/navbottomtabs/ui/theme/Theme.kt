...
// Theme.kt
//
// Defines NavBottomTabsTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.navbottomtabs.ui.theme
...
/**
 * NavBottomTabsTheme — wrap the app's content in this to apply the design system.
 *
